...
export default function Plans() {
    return (
        <div>
            <section className='banner bg-[#ffffff] text-[#000000] flex items-center justify-center'>
                <div className="grid lg:mt-[4rem] mt-[10rem] grid-cols-1 lg:grid-cols-2 items-center">
                    <div className='lg:ps-[10rem] lg:text-justify text-center text-[3rem]'>
