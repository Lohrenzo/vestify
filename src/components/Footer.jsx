...
export default function Footer() {
    return (
        <section className="section pt-[5rem] px-2 bg-[#06091D]">
            <div className='flex justify-center gap-y-5 gap-x-5 lg:flex-nowrap lg:flex-row flex-col lg:px-[10rem] px-[4rem] lg:mb-[3rem] mb-[2rem]'>
                <div className='lg:w-[40%]'>
                    ...
                    <p className='text-justify lg:me-4'>
                        {/* Founded and managed by leading industry professionals Coin Farming Shares was established with a clear vision: To provide unrivaled trading solutions to investors from all over the world with a stellar client centered culture <br /> */}
                ...
                <div className='lg:text-left text-center lg:w-[20%]'>
                ...
                <div id='contact' className='lg:text-left text-center lg:w-[20%]'>
                    ...
                    <ul className="lg:flex lg:flex-col justify-around gap-[10px]">
                        ...
                        <p>
                            <Link to='/' title='About Us' activeclass='active' className='text-inherit hover:text-inherit'>
            ...
            <div className="flex flex-col p-[2rem] justify-center items-center">
                <p className='pb-1'>Copyright © <span className='font-bold text-[1.2rem]'>2023.</span> All Rights Reserved by Vestify</p>
            {/* <a className='opacity-30' href="https://lovepik.com/images/png-person.html">Png vectors by Lovepik.com</a> */}
